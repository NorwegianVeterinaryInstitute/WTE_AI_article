...
Dropping the outgroup long branch - The is the final rooted tree

```{r}
rooted_tree <- 
  ape::drop.tip(rooted_tree1,  c("EPI_ISL_1254","EPI_ISL_177506"))
```
...
<!-- using rooted_tree1 because its the tree that contains all info we display + outgroup --> 
...
_Figure caption:_
H5N5 NA segment. ML phylogenetic tree. The tree is rooted, 
