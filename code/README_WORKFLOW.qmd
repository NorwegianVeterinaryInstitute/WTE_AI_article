...
- [x]   `SEP_H5N1_HA_all_phylogenetic_tree.qmd` - rerun according to same model - with all isolates to be able to compare with NA - I think NA was best
...
4. Packages used citat - session info 
...
# Diverse 
- [ ] Open github repository with scripts before submission 
- [ ] Add a licence - Ask Karin what type I should use so I can use that to make package afterwards
- [ ] clean dependencies that are absolutely necessary for the scripts to work (let the scales as it was used 
to create the scales)
- [ ] organize and move the prep scripts into the folder so its accessible 
